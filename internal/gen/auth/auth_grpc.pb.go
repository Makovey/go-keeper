...
func (c *authClient) Register(ctx context.Context, in *User, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedAuthServer) Register(context.Context, *User) (*emptypb.Empty, error) {
