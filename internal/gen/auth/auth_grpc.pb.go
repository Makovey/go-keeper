...
func (c *authClient) RegisterUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*AuthResponse, error) {
...
func (c *authClient) LoginUser(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
...
func (UnimplementedAuthServer) RegisterUser(context.Context, *User) (*AuthResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterUser not implemented")
}
func (UnimplementedAuthServer) LoginUser(context.Context, *LoginRequest) (*AuthResponse, error) {
